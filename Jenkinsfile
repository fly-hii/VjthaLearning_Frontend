pipeline {
    ...
    environment {
        ...
        EC2_HOST = 'ubuntu@54.91.4.56'                     // ✅ Correct - replace with your EC2 public IP
    }
    ...
    stages {
        ...
        stage('Deploy to EC2') {
            steps {
                ...
                sshagent(credentials: ['ec2-ssh-key']) { // ✅ Use Jenkins SSH Key Credential ID
                    sh '''
...
//         DOCKERHUB_USERNAME = 'flyhii'
//         IMAGE_NAME = 'vjthalearning_frontend'
//         EC2_HOST = 'ubuntu@54.91.4.56'                // 👉 Replace with actual EC2 public IP
//     }
