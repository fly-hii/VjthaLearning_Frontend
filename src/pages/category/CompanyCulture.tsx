...
const CompanyCulture = () => {
  ...
  const { data: articles = [], isLoading } = useQuery({
    queryKey: ['articles', 'company-culture', page],
    queryFn: () => articlesApi.getByCategory('company-culture', { limit: articlesPerPage, page }),
  });
            ...
            <div className="flex-1" style={{ width: '75%' }}>
              {isLoading ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-600 mb-8">Check back later for new company culture articles.</p>
                </div>
              ) : (
