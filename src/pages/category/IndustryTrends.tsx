...
import { trendsArticles } from '@/lib/mockdata';
...
const IndustryTrends = () => {
  ...
  // Pagination logic
  const totalPages = Math.ceil(trendsArticles.length / articlesPerPage);
  const startIndex = (currentPage - 1) * articlesPerPage;
  const endIndex = startIndex + articlesPerPage;
  const paginatedArticles = trendsArticles.slice(startIndex, endIndex);
              ...
              <div className="bg-gray-100 p-6">
                <div className="mb-6">
                  <p className="text-gray-600">
                    Showing {startIndex + 1}-{Math.min(endIndex, trendsArticles.length)} of {trendsArticles.length} articles
                  </p>
                </div>
