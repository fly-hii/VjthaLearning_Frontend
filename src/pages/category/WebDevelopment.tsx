...
const WebDevelopment = () => {
  ...
  const { data: articles = [], isLoading } = useQuery({
    queryKey: ['articles', 'web-development', page],
    queryFn: () => articlesApi.getByCategory('web-development', { limit: articlesPerPage, page }),
  });
            ...
            <div className="flex-1" style={{ width: '75%' }}>
              {isLoading ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-600 mb-8">Check back later for new web development articles.</p>
                </div>
              ) : (
